...
const inventoryManagementNav = [
    ...
    { name: "Tank Analytics", href: "/operations/inventory/tank-analytics", icon: Gauge },
...
export function AppSidebar() {
    ...
    const isCashier = user?.designation === "Cashier" && user?.role !== "PRIME" && user?.role !== "OWNER" && user?.role !== "ADMIN" && user?.role !== "SYSTEM_ADMIN";
