                                            ...
                                            >
                                                <div className="flex items-center justify-between mb-1">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        {inv.autoGenerated && (
                                                            <span
                                                                title="System-generated at shift close to cover residual cash sale"
                                                                className="text-[10px] px-1.5 py-0 rounded bg-muted text-muted-foreground uppercase tracking-wider"
                                                            >
                                                                Auto
                                                            </span>
                                                        )}
