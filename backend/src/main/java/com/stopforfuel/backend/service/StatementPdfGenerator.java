...
public class StatementPdfGenerator {
    ...
    private static final Font F_SECTION = new Font(Font.HELVETICA, 10, Font.BOLD, BLACK);
    private static final Font F_SUMMARY_TH = new Font(Font.HELVETICA, 8, Font.BOLD, HEADER_FG);
    private static final Font F_SUMMARY_TD = new Font(Font.HELVETICA, 9, Font.NORMAL, BLACK);
    private static final Font F_SUMMARY_BOLD = new Font(Font.HELVETICA, 9, Font.BOLD, BLACK);
    ...
    // Two-pass: total page count is unknown until close, so reserve a template
    // and stamp it after the document finishes rendering.
