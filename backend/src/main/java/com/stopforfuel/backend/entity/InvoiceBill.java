...
public class InvoiceBill extends BaseEntity {
    ...
    /** True when the system auto-raised this bill at shift close to capture the residual meter-vs-invoiced cash sale. */
    @Column(name = "auto_generated", nullable = false, columnDefinition = "boolean not null default false")
    private boolean autoGenerated = false;

    /** Set once applySale has decremented non-fuel line items from WAC stock, to keep the hook idempotent across re-saves. */
